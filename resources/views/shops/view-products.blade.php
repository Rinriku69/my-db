@extends('shops.main', ['title' => $shopCode.' Product'])
@section('header')
    <nav>

        <search>
            <form action="{{ route('shops.view-products', ['shopCode' => $shopCode]) }}" method="get">
                <div class="form">
                ...
                <div class="button">
                    ...
                    <a href="{{ route('shops.view-products', ['shopCode' => $shopCode]) }}">
                        <button type="button">X</button>
                    </a>
                </div>
            </form>
        </search>
        <li class="app-cmp-links"><a href="{{ route('shops.view', ['shopCode' => $shopCode]) }}">Back</a></li>
